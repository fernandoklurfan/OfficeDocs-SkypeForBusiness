...
|Microsoft Teams Rooms (MTR) (Windows) can join as a presenter<sup>2</sup> |![Image of a checkmark for yes](/office/media/icons/success-teams.png)|![Image of a checkmark for yes](/office/media/icons/success-teams.png)|![Image of a checkmark for yes](/office/media/icons/success-teams.png)|
...
<sup>2</sup> Only MTRs on Windows with a Pro license can join meetings and events as a presenter. However, MTRs can't send chat messages. Organizers must add MTRs from external organizations as external presenters. MTRs can't send chat messages.
