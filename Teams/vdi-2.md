...
Customers with Thin Clients that have [Unified Write Filters](https://learn.microsoft.com/en-us/windows/configuration/unified-write-filter/) applied should create the following exclusions in order to allow SlimCore MSIX packages to be provisioned:
