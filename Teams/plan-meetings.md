...
|Microsoft Teams Rooms (Windows) can join as a presenter|No control.| Can add Microsoft Teams Rooms on Windows with a Pro license as a presenter. However, Microsoft Teams Rooms can't send chat messages. Organizers must add Microsoft Teams Rooms from external organizations as external presenters.|
